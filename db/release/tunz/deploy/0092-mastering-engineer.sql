...
BEGIN;
  ...
  --||--
  ALTER TABLE tunz.mastering_engineer ADD CONSTRAINT fk_mastering_engineer_studio_session FOREIGN KEY ( studio_session_id ) REFERENCES tunz.studio_session( id );
